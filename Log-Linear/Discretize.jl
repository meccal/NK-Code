...
function Tau(ρ::Float64, σ::Union{Float64, Int64}, K::Int64=9, λ::Number=3, interc::Number=0)
    #Initial point
    z_1=-λ*σ/sqrt(1-ρ^2)
    #size of the step
    step=-2*z_1/(K-1)
...
function discr(x_t::Number,  σ::Union{Float64, Int64}, K::Int64=9, interc::Number=0, β::Number=1)
